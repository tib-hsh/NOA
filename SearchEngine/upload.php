...
if ($ajax) {
    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <b>What will be uploaded in my name?</b><br>
            The tool will upload the image, the caption and article metadata and tag the image with the categories you choose. It will also create a category for the journal the article is from and put the image in that category.<br><br>
