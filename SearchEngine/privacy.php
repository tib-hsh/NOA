...
<div class="main">
    <div class="container">
        <p class="h2">Datenschutzerklärung</p>
        <p>
            <strong>I. Verantwortlicher</strong>
        </p>
        <p>
            Hochschule Hannover,
            <br/>
        ...
        <p>
            <strong>II. Behördlicher Datenschutzbeauftragter</strong>
        </p>
        <p>
        ...
        <p>
            <strong>III. Zuständige Aufsichtsbehörde</strong>
        </p>
        <p>
        ...
        <p>
            <strong>IV. Allgemeines zur Datenverarbeitung</strong>
        </p>
        <p>
        ...
        <p>
            ...
            <em>
                Innen grundsätzlich nur, soweit dies zur Bereitstellung einer
                funktionsfähigen Website sowie unserer Inhalte und Leistungen
                erforderlich ist. Die Verarbeitung personenbezogener Daten unserer
                Nutzer
            </em>
            Innen erfolgt regelmäßig nur nach Einwilligung des Nutzers/der Nutzerin.
            Eine Ausnahme gilt in solchen Fällen, in denen eine vorherige Einholung der
        ...
        <p>
            ...
            erforderlich und überwiegen die Interessen, Grundrechte und Grundfreiheiten
            des Betroffenen das erstgenannte Interesse nicht, so dient Art. 6 Abs. 1
        ...
        <p>
            <strong>V. Bereitstellung der Website und Erstellung von Logfiles</strong>
        </p>
        <p>
            <strong>Beschreibung und Umfang der Datenverarbeitung</strong>
        </p>
        ...
        <p>
            ...
            Nutzers/der Nutzerin findet nicht statt.
        </p>
        <p>
        ...
        <p>
            ...
            notwendig, um eine Auslieferung der Website an den Rechner des Nutzers/der
            Nutzerin zu ermöglichen. Hierfür muss die IP-Adresse des Nutzers/der
            Nutzerin für die Dauer der Sitzung gespeichert bleiben.
        </p>
        <p>
            Die Speicherung in den Logfiles erfolgt, um die Funktionsfähigkeit der
        ...
        <p>
            Im Falle der Speicherung der Daten in den Logfiles ist dies nach spätestens
            14 Tagen der Fall. Eine darüberhinausgehende Speicherung ist möglich. In
            diesem Fall werden die IP-Adressen der Nutzer/die Nutzerin gelöscht oder
        ...
        <p>
            Die Erfassung der Daten zur Bereitstellung der Webseite und die Speicherung
            der Daten in Logfiles ist für den Betrieb der Internetseite zwingend
            erforderlich. Es besteht folglich seitens des Nutzers/der Nutzerin keine
            Widerspruchsmöglichkeit.
        </p>
        <p>
            <strong>VI. Verwendung von Cookies</strong>
        </p>
        <p>
            <strong>Beschreibung und Umfang der Datenverarbeitung</strong>
        </p>
        <p>
            ...
            Computersystem des Nutzers/der Nutzerin gespeichert werden. Ruft ein/eine
            Nutzer*In eine Website auf, so kann ein Cookie auf dem Betriebssystem
        ...
        <p>
            Wir setzen Cookies ein, um diese Website nutzerfreundlicher zu gestalten.
        ...
        <p>
            Die auf diese Weise erhobenen Daten der Nutzer
            <em>
                Innen werden durch technische Vorkehrungen pseudonomisiert. Daher ist
                eine Zuordnung der Daten zum aufrufenden Nutzer/zur aufrufenden
                Nutzerin nicht mehr möglich. Die Daten werden nicht gemeinsam mit
                sonstigen personenbezogenen Daten der Nutzer
            </em>
            Innen gespeichert.
        </p>
        <p>
            Beim Aufruf unserer Website werden die Nutzer*Innen durch einen Infobanner
        ...
        <p>
            Die Rechtsgrundlage für die Verarbeitung personenbezogener Daten unter der
        ...
        <p>
            ...
            Websites für den Nutzer/die Nutzerin zu vereinfachen. Einige Funktionen
            unserer Internetseite können ohne den Einsatz von Cookies nicht angeboten
            werden. Für diese ist es erforderlich, dass der Browser auch nach dem
        ...
        <ul type="disc">
            <li>
                Beim nächsten Aufruf der Seite werden die gleichen Sucheinstellungen
                verwendet
            </li>
        </ul>
        <p>
        ...
        <p>
            ...
            unserer Website und Ihrer Inhalte zu verbessern. Durch die Analyse-Cookies
        ...
        <p>
            Cookies werden auf dem Rechner des Nutzers/der Nutzerin gespeichert und von
            diesem an unsere Seite übermittelt. Daher haben Sie als Nutzer*In die volle
        ...
        <p>
            <strong>VII. Kontaktformulare und E-Mail Kontakt</strong>
        </p>
        <p>
            <strong>Beschreibung und Umfang der Datenverarbeitung</strong>
        </p>
        <p>
            ...
            elektronische Kontaktaufnahme genutzt werden können. Nimmt ein/eine
            Nutzer*In diese Möglichkeit wahr, so werden die in der Eingabemaske
        ...
        <p>
            Alternativ kann eine Kontaktaufnahme über eine bereitgestellte
            E-Mail-Adresse möglich sein. In diesem der Fall werden die mit der E-Mail
            übermittelten personenbezogenen Daten des Nutzers/der Nutzerin gespeichert.
        </p>
        <p>
        ...
        <p>
            ...
            Einwilligung des Nutzers/der Nutzerin Art. 6 Abs. 1 lit. a DSGVO.
        </p>
        <p>
            ...
            Zielt der E-Mail Kontakt auf den Abschluss einer Vertrages ab, so ist
        ...
        <p>
            ...
            mit dem Nutzer/der Nutzerin beendet ist. Beendet ist die Konversation dann,
        ...
        <p>
            <strong>Widerspruchs- und Beseitigungsmöglichkeiten</strong>
        </p>
        <p>
            Der Nutzer/die Nutzerin hat jederzeit die Möglichkeit, seine/ihre
            Einwilligung zur Verarbeitung der personenbezogenen Daten zu widerrufen.
            Nimmt der Nutzer/die Nutzerin per E-Mail Kontakt mit uns auf, so kann er
            die Speicherung seiner/ihrer personenbezogenen Daten jederzeit
        ...
        <p>
            <strong>VIII. Rechte der betroffenen Person</strong>
        </p>
        <p>
